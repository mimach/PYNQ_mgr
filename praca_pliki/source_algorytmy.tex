...
Jednak z uwagi na wymagania projektu (opisane w \ref{sec:koncepcja}), należało dokładnie przemyśleć jego przebudowę. %TODO przerobić zdanie, że z uwagi na wymagania projektu - które powinny być opisane wcześniej. %ODP OK
Schemat \ref{fig:architecture} przedstawia połączenia pomiędzy urządzeniami na platformie UAV.  %TODO arch. sygnałową - dziwne określenie %ODP OK 
\begin{figure}[]
	\centering
