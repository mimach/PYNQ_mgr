...
\acknowledgements{Serdecznie dziękuję mojemu promotorowi Panu dr inż. Tomaszowi Kryjakowi za wsparcie merytoryczne, oraz bliskim za udzieloną pomoc i wsparcie w trakcie pisania tej pracy.}
...
\tableofcontents
\clearpage
\input{praca_pliki/source_wstep}
\input{praca_pliki/source_koncepcja}
\input{praca_pliki/source_przeglad}
\input{praca_pliki/source_algorytmy}
\input{praca_pliki/source_model}
\input{praca_pliki/source_implementacja}
\input{praca_pliki/source_weryfikacja}
\input{praca_pliki/source_podsumowanie}
\appendix
\input{praca_pliki/source_dvd_content}
\input{praca_pliki/source_opis_techniczny}
